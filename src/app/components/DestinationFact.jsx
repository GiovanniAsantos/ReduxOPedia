...
function DestinationFact() {
  ...
  if (selectedDestination === null) {  // Changed from undefined to null to match initial state
    return (
    ...
    return (
      <div className="text-center border p-3 m-3">
        ...
        Country: {selectedDestination.country} {/* Changed from 'fact' to 'country' to match your data structure */}
      </div>
    );
  }
}
